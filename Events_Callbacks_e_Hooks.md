...
## Diferença entre Event, Hook e callback
...
## Hook que permite alterar dados
...
## plugin_callback() e component_callback()
...
## Como descobrir que um callback já possui Hook substituto
...
## after_config e o Hook correspondente
...
## pre_block_delete e core hook block_delete_pre
...
## Preferir Hook quando existe substituto moderno
...
## Manter callback antigo e Hook quando o plugin suporta branches antigas
...
## Como o Moodle evita chamada dupla na migração
...
## Hooks durante instalação e upgrade
...
## Não migrar cegamente callbacks que ainda não possuem Hook
...
## Evitando hacks no core com Hooks
...
## Um exemplo completo de decisão
...
## Exercício - migrando um callback legado
