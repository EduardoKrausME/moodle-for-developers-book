(() => {
    ...
    const CHAPTERS_EN = {
        ...
        'Chapter_18_Enrolment_Plugins.md': 'Enrolment plugins',
        'Chapter_19_Authentication_Plugins.md': 'Authentication plugins',
        'Chapter_20_Subplugins.md': 'Subplugins',
        'Chapter_21_Gradebook_and_Completion.md': 'Gradebook and Completion',
        'Chapter_22_Question_Engine_and_Quiz.md': 'Question Engine and Quiz',
        'Chapter_23_Privacy_API_and_GDPR.md': 'Privacy API and GDPR',
        'Chapter_24_Backup_and_Restore.md': 'Backup and Restore',
        'Chapter_25_PHPUnit.md': 'PHPUnit',
